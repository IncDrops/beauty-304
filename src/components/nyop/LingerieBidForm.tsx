...
const LingerieBidForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setForm({ name: "", email: "", offer: "", category: "Lingerie" });
    } catch (error) {
  ...
  return (
    <div className="container mx-auto px-4 py-12 flex items-center justify-center min-h-[calc(100vh-8rem)]">
      <Card className="w-full max-w-md glassmorphic">
        <CardHeader>
          <CardTitle className="font-headline text-3xl">Name Your Price: Lingerie</CardTitle>
...
export default LingerieBidForm;
