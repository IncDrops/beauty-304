...
const SafetyBidForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setForm({ name: "", email: "", offer: "", category: "Safety Kits" });
    } catch (error) {
  ...
  return (
    <div className="container mx-auto px-4 py-12 flex items-center justify-center min-h-[calc(100vh-8rem)]">
      <Card className="w-full max-w-md glassmorphic">
        <CardHeader>
          <CardTitle className="font-headline text-3xl">Name Your Price: Safety Kits</CardTitle>
