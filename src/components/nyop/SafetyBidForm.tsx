...
export default function SafetyBidForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Safety kit bid submitted:", form);
    // Future: Send to Firestore 'safetyBids'
  };

  return (
    <form onSubmit={handleSubmit} className="max-w-md mx-auto p-4 space-y-4">
      <h2 className="text-xl font-semibold">Name Your Price for a Safety Kit</h2>
      ...
      <button type="submit" className="bg-blue-700 text-white px-4 py-2">Submit Offer</button>
    </form>
  );
}
